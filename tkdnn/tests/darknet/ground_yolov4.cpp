...
int main() {
    std::string bin_path  = "ground_yolov4";
    ...
    std::string cfg_path  = std::string(TKDNN_PATH) + "/tests/darknet/cfg/ground_yolov4.cfg";
    std::string name_path = std::string(TKDNN_PATH) + "/tests/darknet/names/ground.names";

...
int main() {
    std::string bin_path  = "custom_yolov4";
    ...
    std::string cfg_path  = std::string(TKDNN_PATH) + "/tests/darknet/cfg/custom_yolov4.cfg";
    std::string name_path = std::string(TKDNN_PATH) + "/tests/darknet/names/custom_yolov4.names";
